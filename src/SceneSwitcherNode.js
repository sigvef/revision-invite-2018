(function (global) {
  class SceneSwitcherNode extends NIN.Node {
    ...
    update() {
      ...
      if (offsettedBean < 48 * 8) {
        selectedScene = this.inputs.A;
      } else if (offsettedBean < 48 * 16) {
        selectedScene = this.inputs.B;
      } else if (offsettedBean < 48 * 24) {
        selectedScene = this.inputs.C;
      } else if (offsettedBean < 48 * 32) {
        selectedScene = this.inputs.E;
      } else if (offsettedBean < 48 * 40) {
        selectedScene = this.inputs.F;
      } else if (offsettedBean < 48 * 48) {
        selectedScene = this.inputs.G;
      } else if (offsettedBean < 48 * 56) {
        selectedScene = this.inputs.H;
      } else if (offsettedBean < 48 * 64) {
